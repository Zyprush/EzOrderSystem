    ...
    if (!empty($cart_items)) {
        ...
        try {
            foreach ($cart_items as $item) {
                // Fetch product ingredients associated with the product_id
            ...
            $insert_order = $conn->prepare("INSERT INTO `orders`(user_id, method, address, address1, total_products, total_price, quantity_sold, payment_status) VALUES(?,?,?,?,?,?,?,?)");
            $insert_order->execute([$user_id, $method, $address, $address1, $total_products, $total_price, $total_quantity_sold, $payment]);
    ...
    <section class="checkout">
        ...
        <form action="" method="post">
            ...
            <div class="cart-items">
                <h3>cart items</h3>
                <?php
            $total_products = ''; // Initialize an empty string to hold product details
            $grand_total = 0;
            ...
            <div class="user-info">
                <select name="address1" id="#" class="box" required>
