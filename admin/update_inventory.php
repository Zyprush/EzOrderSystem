    ...
    <section class="update-product">
        ...
        ?>
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" required placeholder="enter item name" name="name" maxlength="100" class="box" value="<?= $fetch_products['name']; ?>">
                    <span>update quantity</span>
                    <input type="number" min="0" max="9999999999" required placeholder="enter item quantity" name="quantity" onkeypress="if(this.value.length == 10) return false;" class="box" value="<?= $fetch_products['quantity']; ?>">
